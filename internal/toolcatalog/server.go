...
var anthropicNameWebSearch = string(aconstant.ValueOf[aconstant.WebSearch]())
...
// 网关不支持 code_interpreter，故 code_execution 不注册；新增 server tool 在此追加，
// 回程 dispatch 自动覆盖。
...
// 回程用它从请求声明的工具里筛出 server tool 身份：
